	...
	<div class="kmap">
		<div class="kmap2">
			...
			<div id="map" style="width:500px;height:400px;"></div><br/>
				<b>지하철 이용시 정보</b><br/>
				- 2호선 센텀시티역에서 6번출구, 도보로 10분<br/><br/>
				<b>버스 이용시 정보</b><br/>
				- SK텔레콤 정류장, 시청자미디어센터 정류장 : 307번, 181번(배차간격 18분)<br/>
				- 시청자미디어센터 정류장 : 115번<br/>
				- 센텀시티역 벡스코점 : 115번, 63번, 40번, 5-1번, 155번, 141번, 181번, 39번, 1001번(급행), 1007번(급행), 1002번(급행)<br/><br/>
				<b>부산역에서 이용시 정보</b><br/>
				- 부산역 버스정류장 40, 1001(급행)이용 , 센텀시티역 벡스코점에서 하차 (소요시간 40~50분)<br/>
				- 부산역 지하철 2호선 이용, 센텀시티역 6번출구 이용(소요시간 40분)<br/><br/>
				<b>기차 이용시 정보</b><br/>
				- 서울역에서 부산역까지 KTX로 2시간 40분 소요<br/><br/>
				<b>항공/리무진 이용시 정보</b><br/>
