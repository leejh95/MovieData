...
<!-- ##### Contact Area Start ##### -->
                        ...
                        <!-- Contact Form -->
                            <div class="row">
                               ...
                               <div class="col-12">
                                    <div class="group">
                                    	<br>
                                        <input type="email" name="email" id="searchID_email" required>
                                ...
                                <div class="col-12">
                                    <button type="button" class="btn original-btn" onclick="searchID()">아이디찾기</button>
                                </div>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#searchID_email").keyup(function(key) {

				var email = $("#searchID_email").val().trim();
		...
		function searchID() {
			...
			if (email.length > 0) {
				$("#searchID_email").focus();
				return;
			}
		
			location.href="searchIdForm.inc?email="+$("#searchID_email").val();
